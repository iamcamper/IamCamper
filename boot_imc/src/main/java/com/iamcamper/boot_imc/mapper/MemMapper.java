...
public interface MemMapper {
    ...
    MemVO kakaologin(@Param("snsId") String snsId, @Param("auth") String auth);

    void kakaoinsert(@Param("snsId") String snsId, @Param("snsAuth") String snsAuth,
            @Param("name") String name, @Param("email") String email);

    MemVO kakaoChk(@Param("snsId") String snsId, @Param("snsAuth") String snsAuth);
    ...
    void reg(@Param("id") String id, @Param("pw") String pw, @Param("nickname") String nickname,
            ...
            @Param("phone") String phone); // 회원 가입
