...
public class MemService {
    ...
    public void kakaoinsert(String snsId, String snsAuth, String email, String name) {

        mapper.kakaoinsert(snsId, snsAuth, name, email);

    }

    public MemVO kakaologin(String snsId, String auth) {

        MemVO mvo = mapper.kakaologin(snsId, auth);

        return mvo;

    }

    public MemVO kakaoChk(String snsId, String snsAuth) {

        MemVO mvo = mapper.kakaoChk(snsId, snsAuth);
