    ...
    return(
        <div style={{width:'1600px', margin:'0 auto',height:'100px'}}> 
            <Grid container my={8} style={{textAlign:'center'}}>
                ...
                <Grid item xs><Button variant="contained" style={{width:'100%',height:"100%"}} onClick={()=>router.push("/bbs/free_bbs")}>자유게시판</Button></Grid>
                <Grid item xs><Button variant="contained" style={{width:'100%',height:"100%"}} onClick={()=>router.push("/bbs/buy_bbs")}>중고거래</Button></Grid>
