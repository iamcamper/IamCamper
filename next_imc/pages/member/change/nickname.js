...
export default function nickname(){
    ...
    const ADD_NICKNAME_URL = "/member/add/nickname";
                        ...
                        <FormControl>
                            <Stack direction="column" alignItems="center" spacing={1}>
                                ...
                                <div style={{marginTop:'30px', marginBottom:'30px'}}>
                                    <Button variant="contained" sx={{width:'150px'}} onClick={C_nickname}>변경하기</Button>
                                </div>
                            </Stack>
                        </FormControl>
                    </Paper>
