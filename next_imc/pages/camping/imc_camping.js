...
const getCategory = (event, newValue) => {
 ...
 //---------------------------------------
    ...
    <div className={styles.container}>
      ...
      <Box  div style={{width:'1600px', margin:'0 auto' ,height:"1100px" ,marginTop:'30px'}}>
                ...
                <TableRow key={index}>
                  ...
                  <TableCell styles={{heigth:"250px"}} >
                    ...
                    <div style={{borderBottom:"1px solid #dcdcdc"}} >
                      ...
                      <span style={{display:"inline-block",height:"60px",width:"40%",paddingTop:'20px',fontSize:"15px"}}>
